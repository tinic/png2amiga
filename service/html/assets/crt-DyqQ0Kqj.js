...
`;function d(o,s,e){const r=o.createShader(s);if(!r)throw new Error("CRT shader create failed");if(o.shaderSource(r,e),o.compileShader(r),!o.getShaderParameter(r,o.COMPILE_STATUS)){const i=o.getShaderInfoLog(r);throw o.deleteShader(r),new Error(`CRT shader compile error: ${i??"(no log)"}`)}return r}function P(o,s,e){const r=o.createProgram();if(!r)throw new Error("CRT program create failed");if(o.attachShader(r,s),o.attachShader(r,e),o.linkProgram(r),!o.getProgramParameter(r,o.LINK_STATUS)){const i=o.getProgramInfoLog(r);throw o.deleteProgram(r),new Error(`CRT program link error: ${i??"(no log)"}`)}return r}function L(o){const s=o.getContext("webgl",{premultipliedAlpha:!1,alpha:!1,antialias:!1,preserveDrawingBuffer:!1});if(!s)throw new Error("WebGL not available");const e=s,r=d(e,e.VERTEX_SHADER,S),i=d(e,e.FRAGMENT_SHADER,R),t=P(e,r,i),u=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,u),e.bufferData(e.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),e.STATIC_DRAW);const c=e.createTexture();e.bindTexture(e.TEXTURE_2D,c),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.NEAREST),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE);const a={src:e.getUniformLocation(t,"u_src"),srcSize:e.getUniformLocation(t,"u_srcSize"),outSize:e.getUniformLocation(t,"u_outSize"),hardScan:e.getUniformLocation(t,"u_hardScan"),hardPix:e.getUniformLocation(t,"u_hardPix"),maskDark:e.getUniformLocation(t,"u_maskDark"),maskLight:e.getUniformLocation(t,"u_maskLight"),warpX:e.getUniformLocation(t,"u_warpX"),warpY:e.getUniformLocation(t,"u_warpY"),bloom:e.getUniformLocation(t,"u_bloom"),brightness:e.getUniformLocation(t,"u_brightness")},m=e.getAttribLocation(t,"a_pos");function v(_,l,p,n,f){o.width!==n&&(o.width=n),o.height!==f&&(o.height=f),e.viewport(0,0,n,f),e.clearColor(0,0,0,1),e.clear(e.COLOR_BUFFER_BIT),e.bindTexture(e.TEXTURE_2D,c),e.pixelStorei(e.UNPACK_FLIP_Y_WEBGL,!0),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,l,p,0,e.RGBA,e.UNSIGNED_BYTE,_);const b=l>=480,h=p>=280,w=h?-1:-8,T=b?-5:-3,E=h?.1:.18,x=h?1.1:1.25;e.useProgram(t),e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,c),e.uniform1i(a.src,0),e.uniform2f(a.srcSize,l,p),e.uniform2f(a.outSize,n,f),e.uniform1f(a.hardScan,w),e.uniform1f(a.hardPix,T),e.uniform1f(a.maskDark,.5),e.uniform1f(a.maskLight,1.5),e.uniform1f(a.warpX,1/96),e.uniform1f(a.warpY,1/72),e.uniform1f(a.bloom,E),e.uniform1f(a.brightness,x),e.bindBuffer(e.ARRAY_BUFFER,u),e.enableVertexAttribArray(m),e.vertexAttribPointer(m,2,e.FLOAT,!1,0,0),e.drawArrays(e.TRIANGLE_STRIP,0,4)}function g(){e.deleteProgram(t),e.deleteShader(r),e.deleteShader(i),e.deleteBuffer(u),e.deleteTexture(c)}return{render:v,dispose:g}}export{L as createCrtRenderer};
