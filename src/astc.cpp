...
template <int TexW, int TexH, int GridW, int GridH,
          ...
          block_compress::BlockMetric M>
Candidate encode_block_rgb_2p_decim(const SampleT<TexW * TexH>& s, int best_pi) {
    constexpr int TN = TexW * TexH;
    constexpr int GN = GridW * GridH;
    static constexpr BilinearMap<TexW, TexH, GridW, GridH> bm{};
    constexpr const int* ramp = weight_ramp<WL>();
...
inline Candidate try_decim_2p_cfg(const SampleT<TexW * TexH>& s, int best_pi) {
    return encode_block_rgb_2p_decim<
        TexW, TexH, Cfg.gw, Cfg.gh, Cfg.bm, Cfg.wl, Cfg.epq, M>(s, best_pi);
}
        ...
        if (W == 5 && H == 5)
            return encode_image_impl<5, 5>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<5, 5, M,
                    ...
                    DecimCfg2p{2,4,0x34E,16,40},
                    DecimCfg2p{2,4,0x35F,32,24},
                    DecimCfg2p{2,5,0x17F,8,48},
                    DecimCfg2p{2,5,0x36E,16,24},
                    DecimCfg2p{3,2,0x38E,16,64},
                    DecimCfg2p{3,2,0x39F,32,48},
                    DecimCfg2p{3,3,0x1BF,8,64},
                    DecimCfg2p{3,3,0x3AE,16,32},
                    ...
                    DecimCfg2p{4,3,0x033,8,32},
                    DecimCfg2p{4,4,0x042,4,40},
                    DecimCfg2p{4,5,0x062,4,24},
                    DecimCfg2p{5,2,0x093,8,48},
                    DecimCfg2p{5,2,0x282,16,24},
                    DecimCfg2p{5,3,0x0A2,4,48},
                    DecimCfg2p{5,4,0x0C2,4,24},
                    DecimCfg2p{5,5,0x0E1,2,64}>(),
        ...
        if (W == 6 && H == 5)
            return encode_image_impl<6, 5>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<6, 5, M,
                    ...
                    DecimCfg2p{5,4,0x0C2,4,24},
                    DecimCfg2p{5,5,0x0E1,2,64},
                    DecimCfg2p{6,2,0x102,4,64},
                    DecimCfg2p{6,2,0x113,8,32},
                    DecimCfg2p{6,3,0x122,4,32},
                    DecimCfg2p{6,4,0x141,2,64},
                    DecimCfg2p{6,5,0x161,2,48}>(),
                make_encode_fn_decim_pack<6, 5, M,
                    ...
                    DecimCfg{6,3,0x332,20, 8, 40},
                    DecimCfg{6,3,0x323,24, 8, 24},
                    DecimCfg{6,4,0x153,8, 8, 80},
                    DecimCfg{6,4,0x341,10, 8, 32},
                    DecimCfg{6,5,0x172,5, 8, 96},
                    DecimCfg{6,5,0x163,6, 8, 40}>()));
        if (W == 6 && H == 6)
            return encode_image_impl<6, 6>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<6, 6, M,
                    ...
                    DecimCfg2p{2,5,0x17F,8,48},
                    DecimCfg2p{2,5,0x36E,16,24},
                    DecimCfg2p{2,6,0x00E,4,64},
                    DecimCfg2p{2,6,0x01F,8,32},
                    DecimCfg2p{3,2,0x38E,16,64},
                    DecimCfg2p{3,2,0x39F,32,48},
                    DecimCfg2p{3,3,0x1BF,8,64},
                    DecimCfg2p{3,3,0x3AE,16,32},
                    ...
                    DecimCfg2p{4,4,0x042,4,40},
                    DecimCfg2p{4,5,0x062,4,24},
                    DecimCfg2p{4,6,0x04D,2,64},
                    DecimCfg2p{5,2,0x093,8,48},
                    DecimCfg2p{5,2,0x282,16,24},
                    DecimCfg2p{5,3,0x0A2,4,48},
                    DecimCfg2p{5,4,0x0C2,4,24},
                    DecimCfg2p{5,5,0x0E1,2,64},
                    DecimCfg2p{5,6,0x06D,2,48},
                    DecimCfg2p{6,2,0x102,4,64},
                    DecimCfg2p{6,2,0x113,8,32},
                    DecimCfg2p{6,3,0x122,4,32},
                    DecimCfg2p{6,4,0x141,2,64},
                    DecimCfg2p{6,5,0x161,2,48},
                    DecimCfg2p{6,6,0x104,2,32}>(),
                make_encode_fn_decim_pack<6, 6, M,
                    ...
                    DecimCfg{3,6,0x23E,20, 8, 40},
                    DecimCfg{3,6,0x22F,24, 8, 24},
                    DecimCfg{4,4,0x242,16, 8, 192},
                    DecimCfg{4,4,0x252,20, 8, 96},
                    DecimCfg{4,4,0x243,24, 8, 64},
                    DecimCfg{4,4,0x253,32, 8, 32},
        ...
        if (W == 8 && H == 5)
            return encode_image_impl<8, 5>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<8, 5, M,
                    ...
                    DecimCfg2p{6,4,0x141,2,64},
                    DecimCfg2p{6,5,0x161,2,48},
                    DecimCfg2p{7,2,0x182,4,48},
                    DecimCfg2p{7,2,0x193,8,24},
                    DecimCfg2p{7,3,0x1A2,4,24},
                    DecimCfg2p{7,4,0x1C1,2,48},
                    DecimCfg2p{7,5,0x1E1,2,40},
                    DecimCfg2p{8,2,0x006,4,40},
                    DecimCfg2p{8,3,0x025,2,64},
                    DecimCfg2p{8,4,0x045,2,40},
                    DecimCfg2p{8,5,0x065,2,24}>(),
        ...
        if (W == 8 && H == 8)
            return encode_image_impl<8, 8>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<8, 8, M,
                    ...
                    DecimCfg2p{2,6,0x00E,4,64},
                    DecimCfg2p{2,6,0x01F,8,32},
                    DecimCfg2p{2,7,0x08E,4,48},
                    DecimCfg2p{2,7,0x09F,8,24},
                    DecimCfg2p{2,8,0x00A,4,40},
                    DecimCfg2p{3,2,0x38E,16,64},
                    DecimCfg2p{3,2,0x39F,32,48},
                    DecimCfg2p{3,3,0x1BF,8,64},
                    DecimCfg2p{3,3,0x3AE,16,32},
                    ...
                    DecimCfg2p{3,5,0x1EE,4,48},
                    DecimCfg2p{3,6,0x02E,4,32},
                    DecimCfg2p{3,7,0x0AE,4,24},
                    DecimCfg2p{3,8,0x029,2,64},
                    DecimCfg2p{4,2,0x013,8,64},
                    DecimCfg2p{4,2,0x202,16,40},
                    DecimCfg2p{4,2,0x213,32,24},
                    DecimCfg2p{4,3,0x022,4,64},
                    ...
                    DecimCfg2p{4,5,0x062,4,24},
                    DecimCfg2p{4,6,0x04D,2,64},
                    DecimCfg2p{4,7,0x0CD,2,48},
                    DecimCfg2p{4,8,0x049,2,40},
                    DecimCfg2p{5,2,0x093,8,48},
                    DecimCfg2p{5,2,0x282,16,24},
                    DecimCfg2p{5,3,0x0A2,4,48},
                    DecimCfg2p{5,4,0x0C2,4,24},
                    DecimCfg2p{5,5,0x0E1,2,64},
                    DecimCfg2p{5,6,0x06D,2,48},
                    DecimCfg2p{5,7,0x0ED,2,40},
                    DecimCfg2p{5,8,0x069,2,24},
                    DecimCfg2p{6,2,0x102,4,64},
                    DecimCfg2p{6,2,0x113,8,32},
                    DecimCfg2p{6,3,0x122,4,32},
                    DecimCfg2p{6,4,0x141,2,64},
        ...
        if (W == 10 && H == 5)
            return encode_image_impl<10, 5>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<10, 5, M,
                    ...
                    DecimCfg2p{8,4,0x045,2,40},
                    DecimCfg2p{8,5,0x065,2,24},
                    DecimCfg2p{9,2,0x086,4,32},
                    DecimCfg2p{9,3,0x0A5,2,64},
                    DecimCfg2p{9,4,0x0C5,2,32},
                    DecimCfg2p{10,2,0x106,4,24},
                    DecimCfg2p{10,3,0x125,2,48},
                    DecimCfg2p{10,4,0x145,2,24}>(),
                make_encode_fn_decim_pack<10, 5, M,
                    ...
                    DecimCfg{7,2,0x393,32, 8, 96},
                    DecimCfg{7,3,0x3A1,10, 8, 96},
                    DecimCfg{7,3,0x3B1,12, 8, 48},
                    DecimCfg{7,4,0x1D2,5, 8, 160},
                    DecimCfg{7,4,0x1C3,6, 8, 80},
                    DecimCfg{7,5,0x1E2,4, 8, 96},
                    DecimCfg{7,5,0x1F2,5, 8, 24},
                    DecimCfg{8,2,0x206,16, 8, 192},
                    DecimCfg{8,2,0x216,20, 8, 96},
                    DecimCfg{8,2,0x207,24, 8, 64},
                    DecimCfg{8,2,0x217,32, 8, 32},
                    DecimCfg{8,3,0x037,8, 8, 80},
                    DecimCfg{8,3,0x225,10, 8, 32},
                    DecimCfg{8,4,0x046,4, 8, 192},
                    DecimCfg{8,4,0x056,5, 8, 64},
                    DecimCfg{8,5,0x075,3, 8, 192},
                    DecimCfg{8,5,0x066,4, 8, 32},
                    DecimCfg{9,2,0x295,12, 8, 192},
                    DecimCfg{9,2,0x286,16, 8, 80},
                    DecimCfg{9,2,0x296,20, 8, 40},
                    DecimCfg{9,2,0x287,24, 8, 24},
                    DecimCfg{9,3,0x0A7,6, 8, 96},
                    DecimCfg{9,3,0x0B7,8, 8, 32},
                    DecimCfg{9,4,0x0C6,4, 8, 80},
                    DecimCfg{9,5,0x0F5,3, 8, 80},
                    DecimCfg{10,2,0x305,10, 8, 160},
                    DecimCfg{10,2,0x315,12, 8, 80},
                    DecimCfg{10,2,0x306,16, 8, 32},
                    DecimCfg{10,3,0x136,5, 8, 96},
                    DecimCfg{10,3,0x127,6, 8, 40},
                    DecimCfg{10,4,0x155,3, 8, 192},
                    DecimCfg{10,4,0x146,4, 8, 32},
                    DecimCfg{10,5,0x175,3, 8, 32}>()));
        if (W == 10 && H == 6)
        ...
        if (W == 10 && H == 8)
            return encode_image_impl<10, 8>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_decim_pack<10, 8, M,
                    ...
                    DecimCfg{3,6,0x22F,24, 8, 24},
                    DecimCfg{3,7,0x2AD,10, 8, 96},
                    DecimCfg{3,7,0x2BD,12, 8, 48},
                    DecimCfg{3,8,0x03B,8, 8, 80},
                    DecimCfg{3,8,0x229,10, 8, 32},
                    DecimCfg{4,4,0x242,16, 8, 192},
                    DecimCfg{4,4,0x252,20, 8, 96},
                    DecimCfg{4,4,0x243,24, 8, 64},
                    DecimCfg{4,4,0x253,32, 8, 32},
                    ...
                    DecimCfg{5,6,0x06F,6, 8, 40},
                    DecimCfg{5,7,0x0EE,4, 8, 96},
                    DecimCfg{5,7,0x0FE,5, 8, 24},
                    DecimCfg{5,8,0x079,3, 8, 192},
                    DecimCfg{5,8,0x06A,4, 8, 32},
                    DecimCfg{6,3,0x331,12, 8, 192},
                    DecimCfg{6,3,0x322,16, 8, 80},
                    DecimCfg{6,3,0x332,20, 8, 40},
                    DecimCfg{6,3,0x323,24, 8, 24},
        ...
        if (W == 10 && H == 10)
            return encode_image_impl<10, 10>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<10, 10, M,
                    ...
                    DecimCfg2p{2,7,0x09F,8,24},
                    DecimCfg2p{2,8,0x00A,4,40},
                    DecimCfg2p{2,9,0x08A,4,32},
                    DecimCfg2p{2,10,0x10A,4,24},
                    DecimCfg2p{3,2,0x38E,16,64},
                    DecimCfg2p{3,2,0x39F,32,48},
                    DecimCfg2p{3,3,0x1BF,8,64},
                    DecimCfg2p{3,3,0x3AE,16,32},
                    ...
                    DecimCfg2p{3,7,0x0AE,4,24},
                    DecimCfg2p{3,8,0x029,2,64},
                    DecimCfg2p{3,9,0x0A9,2,64},
                    DecimCfg2p{3,10,0x129,2,48},
                    DecimCfg2p{4,2,0x013,8,64},
                    DecimCfg2p{4,2,0x202,16,40},
                    DecimCfg2p{4,2,0x213,32,24},
                    DecimCfg2p{4,3,0x022,4,64},
                    ...
                    DecimCfg2p{4,7,0x0CD,2,48},
                    DecimCfg2p{4,8,0x049,2,40},
                    DecimCfg2p{4,9,0x0C9,2,32},
                    DecimCfg2p{4,10,0x149,2,24},
                    DecimCfg2p{5,2,0x093,8,48},
                    DecimCfg2p{5,2,0x282,16,24},
                    DecimCfg2p{5,3,0x0A2,4,48},
                    DecimCfg2p{5,4,0x0C2,4,24},
                ...
                make_encode_fn_decim_pack<10, 10, M,
                    ...
                    DecimCfg{2,9,0x29A,20, 8, 40},
                    DecimCfg{2,9,0x28B,24, 8, 24},
                    DecimCfg{2,10,0x309,10, 8, 160},
                    DecimCfg{2,10,0x319,12, 8, 80},
                    DecimCfg{2,10,0x30A,16, 8, 32},
                    DecimCfg{3,5,0x3FE,20, 8, 192},
                    DecimCfg{3,5,0x3EF,24, 8, 128},
                    DecimCfg{3,5,0x3FF,32, 8, 64},
                    DecimCfg{3,6,0x23D,12, 8, 192},
                    ...
                    DecimCfg{3,9,0x0BB,8, 8, 32},
                    DecimCfg{3,10,0x13A,5, 8, 96},
                    DecimCfg{3,10,0x12B,6, 8, 40},
                    DecimCfg{4,4,0x242,16, 8, 192},
                    DecimCfg{4,4,0x252,20, 8, 96},
                    DecimCfg{4,4,0x243,24, 8, 64},
                    DecimCfg{4,4,0x253,32, 8, 32},
        ...
        if (W == 12 && H == 10)
            return encode_image_impl<12, 10>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<12, 10, M,
                    ...
                    DecimCfg2p{10,3,0x125,2,48},
                    DecimCfg2p{10,4,0x145,2,24},
                    DecimCfg2p{11,3,0x1A5,2,40},
                    DecimCfg2p{12,2,0x004,2,64},
                    DecimCfg2p{12,3,0x024,2,32}>(),
                make_encode_fn_decim_pack<12, 10, M,
                    ...
                    DecimCfg{11,2,0x395,12, 8, 32},
                    DecimCfg{11,3,0x1A6,4, 8, 160},
                    DecimCfg{11,3,0x1B6,5, 8, 48},
                    DecimCfg{11,4,0x1D5,3, 8, 96},
                    DecimCfg{12,2,0x01C,8, 8, 80},
                    DecimCfg{12,2,0x204,10, 8, 32},
                    DecimCfg{12,3,0x028,4, 8, 80},
                    DecimCfg{12,4,0x054,3, 8, 48}>()));
        if (W == 12 && H == 12)
            return encode_image_impl<12, 12>(rgba_srgb8, image_w, image_h, options,
                ...
                make_encode_fn_2p_pack<12, 12, M,
                    ...
                    DecimCfg2p{3,9,0x0A9,2,64},
                    DecimCfg2p{3,10,0x129,2,48},
                    DecimCfg2p{3,11,0x1A9,2,40},
                    DecimCfg2p{3,12,0x0A4,2,32},
                    DecimCfg2p{4,2,0x013,8,64},
                    DecimCfg2p{4,2,0x202,16,40},
                    DecimCfg2p{4,2,0x213,32,24},
                    DecimCfg2p{4,3,0x022,4,64},
                ...
                make_encode_fn_decim_pack<12, 12, M,
                    ...
                    DecimCfg{2,11,0x399,12, 8, 32},
                    DecimCfg{2,12,0x09C,8, 8, 80},
                    DecimCfg{2,12,0x284,10, 8, 32},
                    DecimCfg{3,5,0x3FE,20, 8, 192},
                    DecimCfg{3,5,0x3EF,24, 8, 128},
                    DecimCfg{3,5,0x3FF,32, 8, 64},
                    DecimCfg{3,6,0x23D,12, 8, 192},
                    ...
                    DecimCfg{12,2,0x204,10, 8, 32},
                    DecimCfg{12,3,0x028,4, 8, 80},
                    DecimCfg{12,4,0x054,3, 8, 48}>()));  // 5x3 Q24 = 69wb → Q128 (42eb)
